...
{
    public class PrincipalPermissionModeAuthorization : ConfigureServiceBehavior<ServiceAuthorizationBehavior>
    {
        ...
        protected override void Configure(ServiceAuthorizationBehavior serviceBehavior)
        {
            serviceBehavior.PrincipalPermissionMode = m_PrincipalPermissionMode;
        }
    }
}